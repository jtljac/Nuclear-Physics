package org.halvors.datnuclearphysicslite.common.block.machine;
...
import org.halvors.datnuclearphysicslite.common.block.BlockInventory;
import org.halvors.datnuclearphysicslite.common.block.states.BlockStateMachine;
...
public class BlockMachine extends BlockInventory {
    public BlockMachine() {
        ...
        setHardness(3.5F);
        setResistance(16);
        setDefaultState(blockState.getBaseState().withProperty(BlockStateMachine.TYPE, EnumMachine.PARTICLE_ACCELERATOR));
    }
