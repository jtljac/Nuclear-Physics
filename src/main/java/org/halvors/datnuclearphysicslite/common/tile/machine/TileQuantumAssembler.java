package org.halvors.datnuclearphysicslite.common.tile.machine;
...
import org.halvors.datnuclearphysicslite.common.init.ModSoundEvents;
import org.halvors.datnuclearphysicslite.common.network.packet.PacketTileEntity;
import org.halvors.datnuclearphysicslite.common.tile.TileMachine;
import org.halvors.datnuclearphysicslite.common.utility.InventoryUtility;
import org.halvors.datnuclearphysicslite.common.utility.OreDictionaryHelper;
    ...
    public TileQuantumAssembler(final EnumMachine type) {
        ...
        inventory = new ItemStackHandler(7) {
            ...
            protected void onContentsChanged(final int slot) {
                ...
                Item insertedItem = inventory.getStackInSlot(slot).getItem();
                if (slot == 6 && insertedItem != currentItem) {
                    currentItem = insertedItem;
                    operatingTicks = 0;
                }
                markDirty();
            }
